# Generated by Powerlevel10k configuration wizard on 2019-10-15 at 14:11 BST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 34801.
# Wizard options: nerdfont-complete + powerline, small icons, classic, light, time,
# round separators, blurred heads, flat tails, 1 line, compact, many icons, fluent.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n%248F at %180F%m'

  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=178
  # Context format when running with privileges: %n is username, %m is hostname, %B for bold.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%n%248F at %227F%m'
